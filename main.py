...
def datacollected():
    ...
    for i in abc:
        ...
        if(id[1].text.strip().lower() == countrynotification):
            ...
            notification("Corona Recent Cases Of {}".format(countrynotification),
                        "Total Cases : {}\nTotal Deaths : {}\nNew Cases : {}\nNew Deaths : {}".format(
...
coro.resizable(False, False)
coro.eval('tk::PlaceWindow . center')
coro.configure(bg='AntiqueWhite1')
#coro.iconbitmap('corona.png')
flist=[]
path=''
infolabel=Label(coro,text="HEY, HOPE YOU ARE SAFE!!!",font =("Candara Light",15,"bold"),bg="AntiqueWhite1")
infolabel.place(x=15,y=70)

infolabel1=Label(coro,text="You will be able to find the covid data of any country...",font =("Candara Light",15,"bold"),bg="AntiqueWhite1")
infolabel1.place(x=15,y=100)

infolabel2=Label(coro,text="You can even download html, json and csv file of all country data",font =("Candara Light",15,"bold"),bg="AntiqueWhite1")
infolabel2.place(x=15,y=130)

mainlabel = Label(coro,text="Covid Live Tracker",font =("Comic Sans MS",30,"bold"),bg="seashell4",width =33,fg ="black",bd=5)
mainlabel.place(x=0,y=0)

label1 = Label(coro,text="COUNTRY: ",font =("Bookman Old Style",20,"bold"),bg="AntiqueWhite1")
label1.place(x=15,y=185)

label2 = Label(coro,text="DOWNLOAD FILE IN: ",font =("Bookman Old Style",20,"bold"),bg="AntiqueWhite1")
label2.place(x=15,y=265)

cntdata = StringVar()
entry1= Entry(coro,textvariable=cntdata,font=("Bookman Old Style",20,"italic bold"),relief=RIDGE,bd=2,width=32)
entry1.place(x=170,y=185)
#Code for Buttons
Inhtml = Button(coro,text = "html", bg = "steel blue", font = ("arial",15,"italic bold"),relief = RIDGE,activebackground = "#05945B",
             activeforeground = "white",bd = 5,width = 5,command=inhtmldownload)
Inhtml.place(x = 320, y = 265)

Injson = Button(coro,text = "json", bg = "steel blue", font = ("arial",15,"italic bold"),relief = RIDGE,activebackground = "#05945B",
             activeforeground = "white",bd = 5,width = 5,command=injsondownload)
Injson.place(x = 470, y = 265)

Inexcel = Button(coro,text = "excel", bg = "steel blue", font = ("arial",15,"italic bold"),relief = RIDGE,activebackground = "#05945B",
             activeforeground = "white",bd = 5,width = 5,command= inexceldownload)
Inexcel.place(x = 620, y = 265)

Submit = Button(coro,text = "SUBMIT", bg = "OrangeRed2", font = ("arial",15,"italic bold"),relief = RIDGE,activebackground = "#05945B",
             activeforeground = "white",bd = 5,width = 7,command=downloaddata)
Submit.place(x =410, y = 370)
coro.mainloop()
